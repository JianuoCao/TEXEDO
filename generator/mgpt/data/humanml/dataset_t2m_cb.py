    ...
    def __init__(
        ...
        **kwargs,
        ...
        for i, name in enumerator:
            ...
            try:
                # Load motion tokens
                m_tokens_data = np.load(pjoin(motion_dir, f'{name}.npy'))
                # Wrap in list to match expected format (list of token sequences)
                m_token_list = [m_tokens_data] if m_tokens_data.ndim == 1 else m_tokens_data
                # Read text
                    ...
                    for line in lines:
                        try:
                            ...
                            if f_tag == 0.0 and to_tag == 0.0:
                                ...
                                data_dict[new_name]['text'].append(text_dict)
                        except:
                            pass
