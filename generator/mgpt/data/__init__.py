...
class BASEDataModule(pl.LightningDataModule):
    ...
    def val_dataset(self):
        if self._val_dataset is None:
            ...
            params['deterministic'] = bool(
                getattr(self.cfg.EVAL, "DETERMINISTIC", False))
    ...
    def test_dataset(self):
        if self._test_dataset is None:
            ...
            params['deterministic'] = bool(
                getattr(self.cfg.TEST, "DETERMINISTIC_DATA",
                        getattr(self.cfg.TEST, "DETERMINISTIC", False)))
    ...
    def train_dataloader(self):
        ...
        dataloader_options["persistent_workers"] = self.cfg.TRAIN.NUM_WORKERS > 0
        return DataLoader(
            self.train_dataset,
            shuffle=False,
            **dataloader_options,
    ...
    def predict_dataloader(self):
        ...
        dataloader_options["persistent_workers"] = self.cfg.TEST.NUM_WORKERS > 0
    ...
    def val_dataloader(self):
        ...
        dataloader_options["persistent_workers"] = self.cfg.EVAL.NUM_WORKERS > 0
        dataloader_options["shuffle"] = False
        return DataLoader(
            self.val_dataset,
            **dataloader_options,
